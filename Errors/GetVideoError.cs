...
public sealed class GetVideoError : ApiError
{
    ...
    private GetVideoError(Optional<LegacyError> legacyErrorValue, Optional<RawError> fallback) : base(fallback)
    {
        _legacyErrorValue = legacyErrorValue;
    }

    private static GetVideoError AsLegacyError(LegacyError value) =>
