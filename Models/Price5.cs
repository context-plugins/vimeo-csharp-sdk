...
public record Price5
{
    ...
    /// <summary>
    /// When <b>type</b> is <c>film</c>, the rental price of the video in United States dollars. When <b>type</b> is <c>series</c>, the rental price of the entire collection in United States dollars.
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
