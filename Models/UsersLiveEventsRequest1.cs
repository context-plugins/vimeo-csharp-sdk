...
public record UsersLiveEventsRequest1
{
    /// <summary>
    ...
    public AutoCcLang? AutoCcLang { get; init; }
    ...
    public bool? RtmpPreview { get; init; }
    ...
    /// <summary>
    /// The venue UUID to associate with the event.
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [JsonPropertyName("venue_uuid")]
    public string? VenueUuid { get; init; }
}
