...
/// </summary>
public sealed class CategoriesChannels
{
    private readonly RawClient _rawClient;
    private readonly Server _server;
    private readonly AuthSchemes _auth;

    internal CategoriesChannels(RawClient rawClient, Server server, AuthSchemes auth)
    {
    ...
    /// <param name="sort">The way to sort the results.  Option descriptions:  * <c>alphabetical</c> - Sort the results alphabetically.  * <c>date</c> - Sort the results by date.  * <c>followers</c> - Sort the results by number of followers.  * <c>videos</c> - Sort the results by number of videos.</param>
    /// <param name="requestOptions">Per-request options, such as an overriding log level for this call</param>
    /// <param name="ct">Cancellation token</param>
    /// <returns>A <see cref="Task{TResult}"/> of <see cref="ChannelConnection"/> instance.</returns>
    /// <exception cref="SdkException{TResult}"> of <see cref="GetCategoryChannelsError"/> when the server returns an error response.</exception>
    /// <remarks>
    /// This method returns every channel that belongs to the specified category.
    /// </remarks>
    public Task<ChannelConnection> GetCategoryChannels(string category,
        Direction? direction,
        double? page,
        double? perPage,
        string? query,
        ...
        _rawClient.Execute(_server.Default("/categories/{category}/channels"),
            ...
            GetCategoryChannelsErrorResponse.Instance,
