...
/// </para>
/// </summary>
[JsonConverter(typeof(StringEnumConverter<PermissionLevel>))]
public sealed record PermissionLevel : StringEnum<PermissionLevel>
{
    private PermissionLevel(string value) : base(value)
    {
    }

    public static readonly PermissionLevel Admin = new("Admin");

    public static readonly PermissionLevel Contributor = new("Contributor");

    public static readonly PermissionLevel ContributorPlus = new("Contributor Plus");

    public static readonly PermissionLevel Owner = new("Owner");

    public static readonly PermissionLevel Uploader = new("Uploader");

    public static readonly PermissionLevel Viewer = new("Viewer");

    public static PermissionLevel FromValue(string value) => FromValueCore(value);
}
